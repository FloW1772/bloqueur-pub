const TwitchAdblocker = {
  ...
  blockVideoAds() {
    ...
    // Bloquez les publicités qui apparaissent ou disparaissent lorsque la fenêtre du navigateur est redimensionnée
  ...
  blockDynamicAds() {
    ...
    // Ajoutez des règles de filtrage personnalisées
    adblock.addRule("script[src*='twitch.tv/ad/']", "block");
  },
